...
ear_left = c.create_polygon(75,80,75,10,120,45,outline=c.body_color,fill=c.body_color)
ear_right = c.create_polygon(280,40,325,10,320,70,outline=c.body_color,fill=c.body_color)
